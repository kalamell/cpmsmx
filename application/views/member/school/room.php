	...
	<div class="panel panel-default">
	  ...
	  <div class="panel-body">
			<div class="form-group col-md-6">
			    ...
			    <input type="text" class="form-control" name="a1" value="<?php echo $school_room->a1;?>">
			</div>

			<div class="form-group col-md-6">
				<label for="username">อนุบาล 2 (ชื่อเดิม อนุบาล 1)</label>
			    <input type="text" class="form-control" name="a2" value="<?php echo $school_room->a2;?>">
			</div>

			<div class="form-group col-md-6">
				<label for="username">อนุบาล 3 (ชื่อเดิม อนุบาล 2)</label>
			    <input type="text" class="form-control" name="a3" value="<?php echo $school_room->a3;?>">
			</div>

			<div class="form-group col-md-6">
				<label for="username">ประถมศึกษาปีที่ 1</label>
			    <input type="text" class="form-control" name="p1" value="<?php echo $school_room->p1;?>">
			</div>

			<div class="form-group col-md-6">
				<label for="username">ประถมศึกษาปีที่ 2</label>
			    <input type="text" class="form-control" name="p2" value="<?php echo $school_room->p2;?>">
			</div>

			<div class="form-group col-md-6">
				<label for="username">ประถมศึกษาปีที่ 3</label>
			    <input type="text" class="form-control" name="p3" value="<?php echo $school_room->p3;?>">
			</div>

			<div class="form-group col-md-6">
				<label for="username">ประถมศึกษาปีที่ 4</label>
			    <input type="text" class="form-control" name="p4" value="<?php echo $school_room->p4;?>">
			</div>

			<div class="form-group col-md-6">
				<label for="username">ประถมศึกษาปีที่ 5</label>
			    <input type="text" class="form-control" name="p5" value="<?php echo $school_room->p5;?>">
			</div>

			<div class="form-group col-md-6">
				<label for="username">ประถมศึกษาปีที่ 6</label>
			    <input type="text" class="form-control" name="p6" value="<?php echo $school_room->p6;?>">
			</div>

			
			<div class="form-group col-md-6">
				<label for="username">มัธยมศึกษาปีที่ 1</label>
			    <input type="text" class="form-control" name="m1" value="<?php echo $school_room->m1;?>">
			</div>

			<div class="form-group col-md-6">
				<label for="username">มัธยมศึกษาปีที่ 2</label>
			    <input type="text" class="form-control" name="m2" value="<?php echo $school_room->m2;?>">
			</div>

			<div class="form-group col-md-6">
				<label for="username">มัธยมศึกษาปีที่ 3</label>
			    <input type="text" class="form-control" name="m3" value="<?php echo $school_room->m3;?>">
			</div>
